...
%    \end{itemize}
    ...
    This section lists the resources other than third-party software libraries.
    ...
    All the icons (apart from reaction icons, which uses Google Noto Emoji), are in vector format and coded in the Compose Multiplatform.
    They are licensed under the same license as the Compose Multiplatform, \href{https://github.com/JetBrains/compose-multiplatform/blob/master/LICENSE.txt}{Apache 2.0}.
