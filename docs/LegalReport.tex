...
%    \end{itemize}
    ...
    The university has the right to use past exam paper internally.
    Additionally, the university also has the right to distribute and share these questions with other universities.
    Therefore, we should consider the copyright of the past paper questions when we want to use them in Solvo.
