...
const val `ktor-server-auto-head-response-jvm` = "io.ktor:ktor-server-auto-head-response-jvm:${Versions.ktor}"
...
const val `ktor-server-websockets-jvm` = "io.ktor:ktor-server-websockets-jvm:${Versions.ktor}"
const val `ktor-server-status-pages` = "io.ktor:ktor-server-status-pages:${Versions.ktor}"
const val `ktor-server-caching-headers` = "io.ktor:ktor-server-caching-headers:${Versions.ktor}"
...
const val `log4j-api-kotlin` = "org.apache.logging.log4j:log4j-api-kotlin:1.2.0"
